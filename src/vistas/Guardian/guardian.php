...
<nav class="navbar navbar-inverse navbar-fixed-top" data-target="#bs-example-navbar-collapse-3">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			...
			<li><a href="#" data-toggle="modal" onclick="Procesar('contenido','procesarindex/index',[]);return false;"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> Mis Solicitudes</a></li>
